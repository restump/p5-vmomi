...
our @class_members = ( 
    ...
    ['guestHeartbeatStatus', 'ManagedEntityStatus', 0, ],
    ...
    ['ftLogBandwidth', undef, 0, 1],
    ['ftSecondaryLatency', undef, 0, 1],
    ['ftLatencyStatus', 'ManagedEntityStatus', 0, 1],
    ['compressedMemory', undef, 0, 1],
    ['uptimeSeconds', undef, 0, 1],
    ['ssdSwappedMemory', undef, 0, 1],
);
